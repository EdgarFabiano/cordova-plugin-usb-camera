...
public class UVCCameraHelper {
    ...
    public List<UsbDevice> getUsbDeviceList() {
		...
		//List<DeviceFilter> deviceFilters = DeviceFilter.getDeviceFilters(mActivity.getApplicationContext(), cordova.getActivity().getResources().getIdentifier("name", "layout", cordova.getActivity().getPackageName()));
